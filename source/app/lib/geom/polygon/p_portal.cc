...
l3d_polygon_2d* l3d_polygon_3d_portal::clone(void) {
  return new l3d_polygon_3d_portal(*this);
}

l3d_polygon_3d_portal::l3d_polygon_3d_portal(const l3d_polygon_3d_portal &r)
    : l3d_polygon_3d(r)
{
