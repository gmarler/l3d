...
#include "../lib/geom/world/w_oct.h"
...
main() {
  ...
  l3d_world_octree w(320,200);
  void *startinfo;

  w.load_from_file("world.dat");
  w.current_sector = dynamic_cast<l3d_sector *>(w.objects[0]);
  w.camera->VRP = (*w.current_sector->vertices)[0].original;
